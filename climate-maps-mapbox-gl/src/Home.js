...
export default function Home() {
    ...
    return (
        <div className="home-content">
            ...
            <p>
                This project is sponsored by the University of Cincinnati Digital Scholarship Center. We encourage you to <a href="#" onClick={() => { navigate('/methods'); return false }}>explore our methodology</a> and <a href="#" onClick={() => { navigate('/about'); return false }}>learn more about our team</a>.
            </p>
            <hr></hr>
